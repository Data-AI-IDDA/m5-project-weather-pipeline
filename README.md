...
| Variable | Type | Unit | Threshold/Notes |
|---|---|---|---|
| `yield_anomaly` | Continuous (regression) | Tonnes | Deviation from district historical mean |
| `planting_risk_label` | Binary (classification) | 0 / 1 | 1 if planting risk score ≥ 60th percentile |
| `growing_risk_label` | Binary (classification) | 0 / 1 | 1 if growing risk score ≥ 60th percentile |
| `boll_risk_label` | Binary (classification) | 0 / 1 | 1 if boll forming risk score ≥ 60th percentile |
| `harvest_risk_label` | Binary (classification) | 0 / 1 | 1 if harvest risk score ≥ 60th percentile | 
